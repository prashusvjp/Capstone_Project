...
Point2f Source[] = {Point2f(130,135),Point2f(270,135),Point2f(100,185), Point2f(305,185)};
...
{
    if(!Traffic_Cascade.load("//home//pi//Code//machine//Traffic_light_model_2.xml"))
    {
...
{
    if(!Object_Cascade.load("//home//pi//Code//machine//"))
    {
